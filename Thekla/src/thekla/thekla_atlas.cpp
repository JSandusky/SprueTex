...
void Thekla::atlas_set_default_options(Atlas_Options * options) {
    if (options != NULL) {
        ...
        options->charter_options.witness.roundness_metric_weight = 0.01f;// 0.25f;//0.01f;
        options->charter_options.witness.straightness_metric_weight = 4.0f;
        ...
        options->charter_options.witness.max_boundary_length = FLT_MAX;// 30.0f;//FLT_MAX;
