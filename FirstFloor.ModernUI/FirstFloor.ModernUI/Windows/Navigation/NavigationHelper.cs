    ...
    public static class NavigationHelper
    {
        ...
        public static ModernFrame FindFrame(string name, FrameworkElement context)
        {
            ...
            if (name == null || name == FrameSelf) {
                ...
                var ret = frames.FirstOrDefault();
                if (ret == null && context is IFrameLocator)
                    return ((IFrameLocator)context).TargetFrame();
            ...
            if (context is IFrameLocator)
                frame = ((IFrameLocator)context).TargetFrame();
