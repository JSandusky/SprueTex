...
namespace g3
{
    abstract public class MeshGenerator
    {
        ...
        static Microsoft.Xna.Framework.Vector3[] ToUnityVector3(VectorArray3f a, bool bFlipLR = false) {
            Microsoft.Xna.Framework.Vector3[] v = new Microsoft.Xna.Framework.Vector3[a.Count];
        ...
        static Microsoft.Xna.Framework.Vector3[] ToUnityVector3(VectorArray3d a, bool bFlipLR = false) {
            Microsoft.Xna.Framework.Vector3[] v = new Microsoft.Xna.Framework.Vector3[a.Count];
            float fZSign = (bFlipLR) ? -1 : 1;
            for (int i = 0; i < a.Count; ++i) {
        ...
        static Microsoft.Xna.Framework.Vector2[] ToUnityVector2(VectorArray2f a) {
            Microsoft.Xna.Framework.Vector2[] v = new Microsoft.Xna.Framework.Vector2[a.Count];
            for (int i = 0; i < a.Count; ++i) {
