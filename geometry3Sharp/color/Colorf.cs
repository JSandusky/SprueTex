...
namespace g3
{
    public struct Colorf : IComparable<Colorf>, IEquatable<Colorf>
    {
        ...
        public static implicit operator Colorf(Microsoft.Xna.Framework.Color c)
        {
            return new Colorf(c.R / 255.0f, c.G / 255.0f, c.B / 255.0f, c.A/255.0f);
        }
        public static implicit operator Microsoft.Xna.Framework.Color(Colorf c)
        {
