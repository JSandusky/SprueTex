...
namespace g3
{
    public struct AxisAlignedBox3f : IComparable<AxisAlignedBox3f>, IEquatable<AxisAlignedBox3f>
    {
        ...
        public static implicit operator AxisAlignedBox3f(Microsoft.Xna.Framework.BoundingBox b)
        {
            return new AxisAlignedBox3f(b.Min, b.Max);
        }
        public static implicit operator Microsoft.Xna.Framework.BoundingBox(AxisAlignedBox3f b)
        {
            Microsoft.Xna.Framework.BoundingBox ub = new Microsoft.Xna.Framework.BoundingBox();
            ub.Min = b.Min;
            ub.Max = b.Max;
            return ub;
        }
