...
#if G3_USING_MONOGAME
        public static implicit operator Ray3d(Microsoft.Xna.Framework.Ray r)
        {
            return new Ray3d(r.Position, ((Vector3d)r.Direction).Normalized);
        }
        public static explicit operator Microsoft.Xna.Framework.Ray(Ray3d r)
        {
            return new Microsoft.Xna.Framework.Ray((Microsoft.Xna.Framework.Vector3)r.Origin, Microsoft.Xna.Framework.Vector3.Normalize(((Microsoft.Xna.Framework.Vector3)r.Direction)));
        }
#endif
...
#if G3_USING_MONOGAME
        public static implicit operator Ray3f(Microsoft.Xna.Framework.Ray r)
        {
            return new Ray3f(r.Position, r.Direction);
        }
        public static implicit operator Microsoft.Xna.Framework.Ray(Ray3f r)
        {
            return new Microsoft.Xna.Framework.Ray(r.Origin, r.Direction);
        }
#endif
