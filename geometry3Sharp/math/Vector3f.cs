...
namespace g3
{
    public struct Vector3f : IComparable<Vector3f>, IEquatable<Vector3f>
    {
        ...
        public static implicit operator Vector3f(Microsoft.Xna.Framework.Vector3 v)
        {
            return new Vector3f(v.X, v.Y, v.Z);
        }
        public static implicit operator Microsoft.Xna.Framework.Vector3(Vector3f v)
        {
            return new Microsoft.Xna.Framework.Vector3(v.x, v.y, v.z);
        }
        public static implicit operator Microsoft.Xna.Framework.Color(Vector3f v)
        {
            return new Microsoft.Xna.Framework.Color(v.x, v.y, v.z, 1.0f);
        }
        public static implicit operator Vector3f(Microsoft.Xna.Framework.Color c)
        {
