...
namespace g3
{
    ...
    public struct Quaternionf
    {
        ...
        public static implicit operator Quaternionf(Microsoft.Xna.Framework.Quaternion q)
        {
            return new Quaternionf(q.X, q.Y, q.Z, q.W);
        }
        public static implicit operator Microsoft.Xna.Framework.Quaternion(Quaternionf q)
        {
