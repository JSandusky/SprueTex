...
namespace SprueEngine
{
    ...
    void PBRAlbedoEnforcerNode::Register(Context* context)
    {
        ...
        REGISTER_PROPERTY_MEMORY(PBRAlbedoEnforcerNode, bool, offsetof(PBRAlbedoEnforcerNode, StrictMode), false, "Strict Mode", "Raises the lower bound from 30 to 50", PS_VisualConsequence);
    }
