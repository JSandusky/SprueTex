...
void ContrastNode::Register(Context* context)
{
    ...
    REGISTER_PROPERTY_MEMORY(ContrastNode, float, offsetof(ContrastNode, Power), 1.2f, "Power", "Intensity of the value partitioning", PS_SmallIncrement | PS_Permutable);
}
...
void FromNormalizedRange::Register(Context* context)
{
    ...
    REGISTER_PROPERTY_MEMORY(FromNormalizedRange, RangedFloat, offsetof(FromNormalizedRange, range_), RangedFloat(0.0f, 1.0f), "Range", "Remaps values OUT of a normalized range, ie. 0.0-1.0 into 0.5-1.0", PS_Default | PS_NormalRange | PS_Permutable);
}
