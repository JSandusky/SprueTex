...
namespace SprueEngine
{
    ...
    typedef long (*UV_CALLBACK)(float f);
    ...
    public:
        ...
        void SweepRayForWinding(const Ray& ray, unsigned& winding, const Mat3x4& trans = Mat3x4::identity) const;
        ...
        void ComputeUVCoordinates(unsigned width, unsigned height, int quality = 0, int charts = 0, float stretch = 0.75f, float gutter = 2.0f, UV_CALLBACK = 0x0);
        ...
        std::vector<MorphTarget>& GetMorphTargets() { return morphTargets_; }
        const std::vector<MorphTarget>& GetMorphTargets() const { return morphTargets_; }
