...
namespace SprueEngine
{
    ...
    typedef bool (*BoneWeightCancelCallback)();
    ...
    public:
        ...
        static void CalculateBoneWeightsV2(MeshData* meshData, Skeleton* skeleton, BoneWeightCancelCallback callback = 0x0);
        static void CalculateBoneWeightsV3(MeshData* meshData, Skeleton* skeleton, ResponseCurve curve, BoneWeightCancelCallback callback = 0x0);
    };
