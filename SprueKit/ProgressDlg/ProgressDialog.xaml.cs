...
namespace Parago.Windows
{
    public partial class ProgressDialog : Window
    {
        ...
        {
            return ExecuteInternal(owner, title, label, (object)operation, null);
        }
        ...
        {
            return ExecuteInternal(owner, title, label, (object)operation, settings);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Action<BackgroundWorker> operation)
        {
            return ExecuteInternal(owner, title, label, (object)operation, null);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Action<BackgroundWorker> operation, ProgressDialogSettings settings)
        {
            return ExecuteInternal(owner, title, label, (object)operation, settings);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Action<BackgroundWorker, DoWorkEventArgs> operation)
        {
            return ExecuteInternal(owner, title, label, (object)operation, null);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Action<BackgroundWorker, DoWorkEventArgs> operation, ProgressDialogSettings settings)
        {
            return ExecuteInternal(owner, title, label, (object)operation, settings);
        }
        ...
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, null);
        }
        ...
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, settings);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Func<BackgroundWorker, object> operationWithResult)
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, null);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Func<BackgroundWorker, object> operationWithResult, ProgressDialogSettings settings)
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, settings);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Func<BackgroundWorker, DoWorkEventArgs, object> operationWithResult)
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, null);
        }

        internal static ProgressDialogResult Execute(Window owner, string title, string label, Func<BackgroundWorker, DoWorkEventArgs, object> operationWithResult, ProgressDialogSettings settings)
        {
            return ExecuteInternal(owner, title, label, (object)operationWithResult, settings);
        }
        ...
        {
            ProgressDialogResult result = ExecuteInternal(owner, title, label, operation, null);
