namespace Memento
{
    ...
    public sealed class PropertyChangeEvent : BaseEvent
    {
        ...
        protected internal override bool CanMerge(BaseEvent rhs)
        {
            if (rhs is PropertyChangeEvent)
            {
                PropertyChangeEvent other = rhs as PropertyChangeEvent;
                return TargetObject == other.TargetObject && PropertyName.Equals(other.PropertyName);
            }
            return false;
        }

        protected internal override void Merge(BaseEvent rhs)
        {
        }
    }
}
