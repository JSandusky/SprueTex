...
namespace SprueKit.Util
{
    ...
    public class GifWriter : IDisposable
    {
        ...
        /// <param name="Repeat">No of times the Gif should repeat... 0 to repeat indefinitely.</param>
        ...
        #region Write
        void InitHeader(System.IO.Stream SourceGif, System.IO.BinaryWriter Writer, int Width, int Height)
        {
            // File Header
        ...
        static void WriteGraphicControlBlock(System.IO.Stream SourceGif, System.IO.BinaryWriter Writer, int FrameDelay)
        {
        ...
        static void WriteImageBlock(System.IO.Stream SourceGif, System.IO.BinaryWriter Writer, bool IncludeColorTable, int X, int Y, int Width, int Height)
        {
